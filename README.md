...
Hard Skills: Tecnologias que utilizo no dia a dia.
Contacto: Atalhos diretos para o meu LinkedIn e e-mail.
🛠️ Tecnologias Utilizadas
Frontend: HTML5, CSS3, JavaScript.
Backend: Java, NodeJs, Postgre
Framework: (Ex: React, Vue ou Next.js — se usaste algum).
🎨 Design
O design foi pensado para ser clean e responsivo, garantindo uma boa leitura tanto em desktop como em dispositivos móveis
